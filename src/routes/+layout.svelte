...
<!-- Title Bar -->
<div class="fixed top-0 w-full flex items-center justify-between p-4 border-b border-inherit bg-base-100">
    ...
    <div class="flex items-center">
        <a
            ...
            use:tooltip={{
                content:
                    'Interact with the Chat, set your persona, and label your conversations. Ask me.... <some sample question>',
                position: 'bottom',
                autoPosition: true,
                align: 'center',
                animation: 'slide',
